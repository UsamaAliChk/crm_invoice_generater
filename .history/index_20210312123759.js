...
var con = mysql.createConnection({
  ...
  try{
    ...
    con.query("insert into company (companyName,companyEmail,companyPhoneNumber,country,addressId) values ('samways','samways.com','0093178817992','UK',3)",function(err,rows,feilds){
      if(err)
      throw err;
      else{
        console.log(rows)
