...
var con = mysql.createConnection({
  ...
  try{
      ...
      con.query("insert into contact (firstName,lastName,title,contactEmail,contactPhoneNumber,addressId,companyId) values ('Arslan','Ali','Mr','arslanali@gmail.com','007854321111',1,2)",(err,row)=>{
        if(err) throw err;
        console.log(row)
      })
  }
