...
var con = mysql.createConnection({
  ...
  try{
    ...
    con.query("insert into company (companyName,companyEmail,companyPhoneNumber,country,addressId) values ('siyahat','siyahat.com','0093178817992','canada',2)",function(err,rows,feilds){
      if(err)
      throw err;
      else{
        console.log(rows)
