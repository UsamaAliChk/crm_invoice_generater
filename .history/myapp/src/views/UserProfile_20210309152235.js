...
function User() {
  ...
  const styles = {textAlign: 'center',marginTop:, fontSize: '26px', color: '#ff9900', position: 'fixed', verticalAlign: 'middle', left:'0px', top: '0px', width:'100%', height:'100%', backgroundColor: 'rgba(0,0,0,0.2)'}
  if(data.length===0){
      return(
        <Loader  type="Circles"
