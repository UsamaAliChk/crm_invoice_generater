...
export default function Documnet1(props) {
       ...
       <Document>
         <Page wrap>
            ...
            <View style={{display:"flex",flexDirection:"row"}}>
               <Text style={style.text}>Spire Tech</Text>
               <Text style={style.invoice}>INVIOCE</Text>
            </View>
            <View style={style.address}>
                <Text>Hi THIS IS UASMA ALI FROM CHAKWAL PAKISTAN</Text>
            </View>
            <View style={style.phoneAndInviove}>
                <Text style={{marginTop:"10px"}}>Phone: 12345678</Text>
                <View style={style.invioceNumberMain}>
                    ...
                    <View style={{display:'flex',justifyContent:'space-between',marginTop:'5px',flexDirection:'row'}}>
                        ...
                        <Text style={{marginRight:'10px'}}>1/2/2001</Text>
                    </View>
                </View>
            </View>
            ...
            <View style={style.totalBox}>
                ...
                <View style={style.subTotal}>
                    <Text style={{marginTop:'5px',fontFamily:'Lato',fontSize:'12'}}>Sub Total</Text>
                </View>
                <View style={style.total}>
                    <Text style={{marginTop:'5px',fontFamily:'Lato',fontSize:'12'}}>Total</Text>
                </View>
            </View>
                <Text style={{position:'absolute',top:770,textAlign:'center',fontSize:11,fontFamily:'Lato'}}>Usama trade center</Text>
