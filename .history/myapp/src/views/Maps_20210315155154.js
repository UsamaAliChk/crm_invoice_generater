...
const handelClick=()=>{
  ...
  if(selectedCompany[0].Address1!==null){
    address.push(selectedCompany[0].Address1);
  }
  if(selectedCompany[0].Address2!==null){
    address.push(selectedCompany[0].Address2);
  }
  if(selectedCompany[0].Address3!==null){
    address.push(selectedCompany[0].Address3);
  }
  if(selectedCompany[0].Address4!==null){
    address.push(selectedCompany[0].Address4);
  }

  let company={name:selectedCompany[0].companyName,companyAddres,Number:selectedCompany[0].companyPhoneNumber};
