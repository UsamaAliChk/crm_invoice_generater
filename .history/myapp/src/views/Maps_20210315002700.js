...
const handelClick=()=>{
  ...
  let company={name:selectedCompany[0].companyName,address:"somwhere I dont know and dont wanna know too"};
...
let billing={Name,phoneNumber,address,contactCompanyName,Email}
  dispatch(setData({company,billing,items,member,totalPrice}))
}
