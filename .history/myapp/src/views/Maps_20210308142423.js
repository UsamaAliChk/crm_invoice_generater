          ...
          <Col md="12">
            <Form>
              ...
              <Row>
                ...
                <Col md="1">
                    <Button style={{marginTop:"30px"}} onClick={e=>{let total1=qty*price;let total2=total+total1;settotal(total2) ; setitems(old=>[...old,{description,qty,price,total1}])}}>ADD</Button>
                </Col>
              </Row>
              <Row>
