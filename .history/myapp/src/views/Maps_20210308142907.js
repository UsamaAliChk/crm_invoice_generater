...
const handelClick=()=>{
  dispatch(setData({company,address,items,member,total}))
}
          ...
          <Col md="12">
            <Form>
              ...
              <Row>
                ...
                <Col md="1">
                    <Button style={{marginTop:"30px"}} onClick={e=>{let total1=qty*price;let total2=totalPrice+total1;settotalPrice(total2) ; setitems(old=>[...old,{description,qty,price,total}])}}>ADD</Button>
                </Col>
              </Row>
              <Row>
