          ...
          <Col md="12">
            <Form>
              ...
              <Row>
                ...
                <Col md="1">
                    <Button style={{marginTop:"30px"}} onClick={e=>{let total=qty*price;let total2=totalPrice+total;settotalPrice(total2);console.log(totalPrice); setitems(old=>[...old,{description,qty,price,total}])}}>ADD</Button>
                </Col>
              </Row>
              <Row>
