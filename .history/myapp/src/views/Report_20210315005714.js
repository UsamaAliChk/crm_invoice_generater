       ...
       <Document>
         <Page wrap>
            ...
            <View style={style.phoneAndInviove}>
                ...
                <View style={style.invioceNumberMain}>
                    ...
                    <View style={{display:'flex',justifyContent:'space-between',marginTop:'5px',flexDirection:'row'}}>
                        ...
                        <Text style={{marginRight:'10px'}}>{date.getDate()+'/'+date.getMonth()+'/'+date.getYear()}</Text>
                    </View>
                </View>
            </View>
            ...
            <View style={style.totalBox}>
                ...
                <Text style={{position:'absolute',top:770,textAlign:'center',fontSize:11,fontFamily:'Lato'}}>{Data.company.name+' '+Data.company.Number} </Text>
